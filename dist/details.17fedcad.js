...
})({"9fpem":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "ba43375017fedcad";
"use strict";
...
},{}],"3THZw":[function(require,module,exports,__globalThis) {
var _recipesJs = require("./recipes.js");
// Combina todas las recetas en un solo array
const allRecipes = [
    ...(0, _recipesJs.asianRecipes),
    ...(0, _recipesJs.spanishRecipes),
    ...(0, _recipesJs.italianRecipes),
    ...(0, _recipesJs.frenchRecipes),
    ...(0, _recipesJs.englishRecipes)
];
function populateDetailsPage() {
    ...
    infoElement.innerHTML = `
            <li><b>Tiempo de preparaci\xf3n:</b> ${recipe.info.prepTime}</li>
            ...
            <li><b>Categor\xeda:</b> ${recipe.info.category}</li>
            <li><b>Tipo de cocina:</b> ${recipe.info.cuisine}</li>
            <li><b>Calor\xedas:</b> ${recipe.info.calories}</li>
    `;
    // Update ingredients
    ...
    textElement.innerHTML = recipe.instructions.map((step)=>`${step}<br>`).join('');
    // Update video
    if (recipe.video) {
...
},{"./recipes.js":"9sqBN"}]},["9fpem","3THZw"], "3THZw", "parcelRequire94c2")

//# sourceMappingURL=details.17fedcad.js.map
